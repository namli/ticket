...
Official plugins (installed separately):
  ...
  set <id> <field> <value> [--no-note]   Change title, priority, type, assignee, tags (a,b | +a,-b)
                           or parent; 'none' removes assignee/tags/parent; notes 'Edited: ...'
